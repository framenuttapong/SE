  ...
  <nav ref="navbar" class="fixed top-0 left-0 w-full bg-primary-200 z-20 transition duration-200"> 
    <div class="container flex items-center justify-between h-20">
      <div class="relative z-30 flex items-center gap-2 mb-2 lg:mb-0">
        <h1 class="text-white font-bold text-lg lg:text-2xl">Car<span class="text-secondary">C</span>ash</h1>
      ...
      >
        ...
        <a @click="showMenu = false" class="text-white font-medium" href="/cars">Car</a>
        <a @click="showMenu = false" class="text-white font-medium" href="/articles">Article</a>
        <a @click="showMenu = false" class="text-white font-medium" href="/offers/send_car_offer">Sell Car</a>
        <div class="dropdown">
          <span class="text-white font-medium">User</span>
          <div class="dropdown-content">
            <a @click="showMenu = false" href="/users/profile">Profile</a>
            <p></p>
            <a @click="showMenu = false" href="/users/buy_history">History</a>
          </div>
        </div>
        <a @click="showMenu = false" class="text-white font-medium" href="/logout">Logout</a>
      </div>

      <div v-if="auth && auth.role === 'staff'"
        class="
          absolute lg:static top-20 inset-x-0
          flex flex-col lg:flex-row items-center gap-5 lg:gap-10
          bg-primary-200 lg:bg-transparent pt-5 pb-10 px-5 lg:p-0
      ...
      >
        <a @click="showMenu = false" class="text-white font-medium" href="/">Home</a>
        <a @click="showMenu = false" class="text-white font-medium" href="/users/profile">Profile</a>
        <div class="dropdown">
          <span class="text-white font-medium">Article</span>
          <div class="dropdown-content">
            <a @click="showMenu = false" href="/articles">All Articles</a>
            <p></p>
            <a @click="showMenu = false" href="/articles/create">Create Article</a>
          </div>
        </div>
        <div class="dropdown">
          <span class="text-white font-medium">Car</span>
          <div class="dropdown-content">
            <a @click="showMenu = false" href="/cars">All Cars</a>
            <p></p>
            <a @click="showMenu = false" href="/cars/sold">Sold Car</a>
            <p></p>
            <a @click="showMenu = false" href="/cars/create">Create Car</a>
          </div>
        </div>
        <div class="dropdown">
          <span class="text-white font-medium">Offer</span>
          <div class="dropdown-content">
            <a @click="showMenu = false" href="/offers">All Offers</a>
            <p></p>
            <a @click="showMenu = false" href="/offers/accepted">Accepted</a>
            <p></p>
            <a @click="showMenu = false" href="/offers/checked">Checked</a>
          </div>
        </div>
        <a @click="showMenu = false" class="text-white font-medium" href="/logout">Logout</a>
      </div>
      ...
      >
        <a @click="showMenu = false" class="text-white font-medium" href="/">Home</a>
        <a @click="showMenu = false" class="text-white font-medium" href="/managers/staffs">All Staff</a>
        <a @click="showMenu = false" class="text-white font-medium" href="/users/profile">Profile</a>
        <div class="dropdown">
          <span class="text-white font-medium">Promotion</span>
          <div class="dropdown-content">
            <a @click="showMenu = false" href="/promotions">All Promotions</a>
            <p></p>
            <a @click="showMenu = false" href="/promotions/create">Create Promotion</a>
          </div>
        </div>
        <a @click="showMenu = false" class="text-white font-medium" href="/logout">Logout</a>
      </div>
      ...
      >
        <a @click="showMenu = false" class="text-white font-medium" href="/">Home</a>
        <a @click="showMenu = false" class="text-white font-medium" href="/cars">Cars</a>
        <a @click="showMenu = false" class="text-white font-medium" href="/articles">Articles</a>
        <a @click="showMenu = false" class="text-white font-medium" href="/offers/send_car_offer">Sell Car</a>
        <a @click="showMenu = false" class="text-white font-medium" href="/register">Register</a>
        <a @click="showMenu = false" class="text-white font-medium" href="/login">Please Login</a>
      </div>
